...
3. **Build the full report**
   ...
   - **Top Untriaged Bugs**: the 10 most critical untriaged bugs needing immediate attention, each key formatted as a clickable link: `[CNV-XXXXX](https://redhat.atlassian.net/browse/CNV-XXXXX)`
